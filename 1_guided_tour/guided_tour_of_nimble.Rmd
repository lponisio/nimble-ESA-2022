...
## Simulate the data 
- There will be 100 sites sampled 10 times per year for 5 years. (Won't this be lovely?)
- data, y: 1 = not-detected, 2 = detected.
- latent states, z: 1 = present, 0 = absent 
- Simulate a time-constant model with 3 different covariates affecting the 3 parameters (phi, gamma, p)  (use the function from the AHMbook package)
